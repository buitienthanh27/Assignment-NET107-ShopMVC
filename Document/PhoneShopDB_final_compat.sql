...
-- =============================================
-- PHONE SHOP DATABASE - FINAL VERSION (Compat)
-- ASP.NET Core 8.0 + Entity Framework Core
-- Compatible with SQL Server versions without TRIM() and CREATE OR ALTER
-- =============================================
...
-- =============================================
-- TRIGGER (use DROP + CREATE for compat)
-- =============================================
...
-- =============================================
-- VIEWS (DROP + CREATE for compat)
-- =============================================

IF OBJECT_ID('dbo.vw_ProductsWithCategory', 'V') IS NOT NULL DROP VIEW dbo.vw_ProductsWithCategory;
GO
...
IF OBJECT_ID('dbo.vw_CartTotals', 'V') IS NOT NULL DROP VIEW dbo.vw_CartTotals;
GO
...
IF OBJECT_ID('dbo.vw_CartDetailsWithProduct', 'V') IS NOT NULL DROP VIEW dbo.vw_CartDetailsWithProduct;
GO
...
JOIN dbo.Carts c ON cd.CartId = c.CartId
JOIN dbo.Users u ON c.UserId = u.UserId
...
IF OBJECT_ID('dbo.vw_OrderDetailsWithProduct', 'V') IS NOT NULL DROP VIEW dbo.vw_OrderDetailsWithProduct;
GO
...
PRINT 'Database created (compat version).';
SELECT TOP 3 * FROM dbo.vw_ProductsWithCategory;
SELECT TOP 3 * FROM dbo.vw_CartTotals;
SELECT TOP 3 * FROM dbo.vw_OrderTotals;
GO
